...
int main(int argc, char* argv[]){
  ...
  main_aux(rank, size, 1,  5, 0.0001, 32, {1,2,24}, "MPI_GLong/OutFiles1");
  main_aux(rank, size, 1, 10, 0.0001, 32, {1,2,24}, "MPI_GLong/OutFiles2");
  main_aux(rank, size, 1, 15, 0.0001, 32, {1,2,24}, "MPI_GLong/OutFiles3");
  main_aux(rank, size, 1,  5, 0.0005, 32, {1,2,24}, "MPI_GLong/OutFiles4");
  main_aux(rank, size, 1, 10, 0.0005, 32, {1,2,24}, "MPI_GLong/OutFiles5");
  main_aux(rank, size, 1, 15, 0.0005, 32, {1,2,24}, "MPI_GLong/OutFiles6");
  main_aux(rank, size, 1,  5,  0.001, 32, {1,2,24}, "MPI_GLong/OutFiles7");
  main_aux(rank, size, 1, 10,  0.001, 32, {1,2,24}, "MPI_GLong/OutFiles8");
  main_aux(rank, size, 1, 15,  0.001, 32, {1,2,24}, "MPI_GLong/OutFiles9");
  main_aux(rank, size, 1,  5, 0.0001, 64, {1,2,24}, "MPI_GLong/OutFiles10");
  main_aux(rank, size, 1, 10, 0.0001, 64, {1,2,24}, "MPI_GLong/OutFiles11");
  main_aux(rank, size, 1, 15, 0.0001, 64, {1,2,24}, "MPI_GLong/OutFiles12");
  main_aux(rank, size, 1,  5, 0.0005, 64, {1,2,24}, "MPI_GLong/OutFiles13");
  main_aux(rank, size, 1, 10, 0.0005, 64, {1,2,24}, "MPI_GLong/OutFiles14");
  main_aux(rank, size, 1, 15, 0.0005, 64, {1,2,24}, "MPI_GLong/OutFiles15");
  main_aux(rank, size, 1,  5,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles16");
  main_aux(rank, size, 1, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles17");
  main_aux(rank, size, 1, 15,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles18");
...
void main_aux(int rank, int size,
  ...
  std::vector<unsigned> which_lags, std::string foldername_outfiles){
    ...
    std::ignore = dt_train.reduce_dataset(">=", "2007-01-03 00:00:00");
    std::ignore = dt_train.reduce_dataset("<",  "2011-01-01 00:00:00");

    Dataset dt_test(filename_);
    std::ignore = dt_test.reduce_dataset(">=", "2011-01-01 00:00:00");
    ...
    const unsigned SHUFFLING_SEED = 20; // original 10
