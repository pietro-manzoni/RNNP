...
//  const NN::type TD = 1.00;    // tail_decay

  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles1",  SS, 100,  200,  1.00);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles2",  SS, 200,  300,  1.00);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles3",  SS, 300,  400,  1.00);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles4",  SS, 400,  500,  1.00);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles5",  SS, 500,  600,  1.00);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles6",  SS, 600,  700,  1.00);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles7",  SS, 700,  800,  1.00);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles8",  SS, 800,  900,  1.00);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles9",  SS, 900,  1000, 1.00);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles10", SS, 1000, 1100, 1.00);

  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles11", SS, 100,  200,  0.90);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles12", SS, 200,  300,  0.90);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles13", SS, 300,  400,  0.90);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles14", SS, 400,  500,  0.90);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles15", SS, 500,  600,  0.90);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles16", SS, 600,  700,  0.90);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles17", SS, 700,  800,  0.90);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles18", SS, 800,  900,  0.90);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles19", SS, 900,  1000, 0.90);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles20", SS, 1000, 1100, 0.90);

  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles21", SS, 100,  200,  0.80);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles22", SS, 200,  300,  0.80);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles23", SS, 300,  400,  0.80);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles24", SS, 400,  500,  0.80);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles25", SS, 500,  600,  0.80);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles26", SS, 600,  700,  0.80);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles27", SS, 700,  800,  0.80);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles28", SS, 800,  900,  0.80);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles29", SS, 900,  1000, 0.80);
  main_aux(rank, size, 2, 10,  0.001, 64, {1,2,24}, "MPI_GLong/OutFiles30", SS, 1000, 1100, 0.80);
