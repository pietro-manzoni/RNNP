...
int main(int argc, char* argv[]){
  ...
  //main_aux(rank, size, 2,  5,  0.0001, 64, {1,2}, "MPI_Cerb/OutFiles1",  SS, 100,  200,  1.00);
  //main_aux(rank, size, 2,  5,  0.0001, 64, {1,2}, "MPI_Cerb/OutFiles2",  SS, 200,  300,  1.00);
  //main_aux(rank, size, 2,  5,  0.0001, 64, {1,2}, "MPI_Cerb/OutFiles3",  SS, 300,  400,  1.00);

  main_aux(rank, size, 2, 10,  0.0001, 64, {1,2}, "MPI_Cerb/OutFiles4",  SS, 100,  200,  1.00);
  return 0;
  main_aux(rank, size, 2, 10,  0.0001, 64, {1,2}, "MPI_Cerb/OutFiles5",  SS, 200,  300,  1.00);
  main_aux(rank, size, 2, 10,  0.0001, 64, {1,2}, "MPI_Cerb/OutFiles6",  SS, 300,  400,  1.00);

  main_aux(rank, size, 2, 15,  0.0001, 64, {1,2}, "MPI_Cerb/OutFiles7",  SS, 100,  200,  1.00);
  main_aux(rank, size, 2, 15,  0.0001, 64, {1,2}, "MPI_Cerb/OutFiles8",  SS, 200,  300,  1.00);
  main_aux(rank, size, 2, 15,  0.0001, 64, {1,2}, "MPI_Cerb/OutFiles9",  SS, 300,  400,  1.00);

  main_aux(rank, size, 2, 20,  0.0001, 64, {1,2}, "MPI_Cerb/OutFiles10", SS, 100,  200,  1.00);
  main_aux(rank, size, 2, 20,  0.0001, 64, {1,2}, "MPI_Cerb/OutFiles11", SS, 200,  300,  1.00);
  main_aux(rank, size, 2, 20,  0.0001, 64, {1,2}, "MPI_Cerb/OutFiles12", SS, 300,  400,  1.00);

  main_aux(rank, size, 2,  5,  0.0005, 64, {1,2}, "MPI_Cerb/OutFiles13", SS, 100,  200,  1.00);
  main_aux(rank, size, 2,  5,  0.0005, 64, {1,2}, "MPI_Cerb/OutFiles14", SS, 200,  300,  1.00);
  main_aux(rank, size, 2,  5,  0.0005, 64, {1,2}, "MPI_Cerb/OutFiles15", SS, 300,  400,  1.00);

  main_aux(rank, size, 2, 10,  0.0005, 64, {1,2}, "MPI_Cerb/OutFiles16", SS, 100,  200,  1.00);
  main_aux(rank, size, 2, 10,  0.0005, 64, {1,2}, "MPI_Cerb/OutFiles17", SS, 200,  300,  1.00);
  main_aux(rank, size, 2, 10,  0.0005, 64, {1,2}, "MPI_Cerb/OutFiles18", SS, 300,  400,  1.00);

  main_aux(rank, size, 2, 15,  0.0005, 64, {1,2}, "MPI_Cerb/OutFiles19", SS, 100,  200,  1.00);
  main_aux(rank, size, 2, 15,  0.0005, 64, {1,2}, "MPI_Cerb/OutFiles20", SS, 200,  300,  1.00);
  main_aux(rank, size, 2, 15,  0.0005, 64, {1,2}, "MPI_Cerb/OutFiles21", SS, 300,  400,  1.00);

  main_aux(rank, size, 2, 20,  0.0005, 64, {1,2}, "MPI_Cerb/OutFiles22", SS, 100,  200,  1.00);
  main_aux(rank, size, 2, 20,  0.0005, 64, {1,2}, "MPI_Cerb/OutFiles23", SS, 200,  300,  1.00);
  main_aux(rank, size, 2, 20,  0.0005, 64, {1,2}, "MPI_Cerb/OutFiles24", SS, 300,  400,  1.00);

  main_aux(rank, size, 2,  5,  0.001,  64, {1,2}, "MPI_Cerb/OutFiles25", SS, 100,  200,  1.00);
  main_aux(rank, size, 2,  5,  0.001,  64, {1,2}, "MPI_Cerb/OutFiles26", SS, 200,  300,  1.00);
  main_aux(rank, size, 2,  5,  0.001,  64, {1,2}, "MPI_Cerb/OutFiles27", SS, 300,  400,  1.00);

  main_aux(rank, size, 2, 10,  0.001,  64, {1,2}, "MPI_Cerb/OutFiles28", SS, 100,  200,  1.00);
  main_aux(rank, size, 2, 10,  0.001,  64, {1,2}, "MPI_Cerb/OutFiles29", SS, 200,  300,  1.00);
  main_aux(rank, size, 2, 10,  0.001,  64, {1,2}, "MPI_Cerb/OutFiles30", SS, 300,  400,  1.00);

  main_aux(rank, size, 2, 15,  0.001,  64, {1,2}, "MPI_Cerb/OutFiles31", SS, 100,  200,  1.00);
  main_aux(rank, size, 2, 15,  0.001,  64, {1,2}, "MPI_Cerb/OutFiles32", SS, 200,  300,  1.00);
  main_aux(rank, size, 2, 15,  0.001,  64, {1,2}, "MPI_Cerb/OutFiles33", SS, 300,  400,  1.00);

  main_aux(rank, size, 2, 20,  0.001,  64, {1,2}, "MPI_Cerb/OutFiles34", SS, 100,  200,  1.00);
  main_aux(rank, size, 2, 20,  0.001,  64, {1,2}, "MPI_Cerb/OutFiles35", SS, 200,  300,  1.00);
  main_aux(rank, size, 2, 20,  0.001,  64, {1,2}, "MPI_Cerb/OutFiles36", SS, 300,  400,  1.00);
